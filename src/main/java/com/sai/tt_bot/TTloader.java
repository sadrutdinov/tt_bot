...
public class TTloader {
    private String convertWebPageToString(String ttUrl) throws Exception {
        String html = Jsoup.connect(ttUrl).get().html();
        return html;
    }
